...
/*!******************************************!*\
  !*** ./resources/js/web/type-writter.js ***!
  \******************************************/
...
var currentLocalization = $('#current_localization').val();
if (currentLocalization === 'en') {
  var sentences = ["Key words: php, database,git...", "Key words: mysql, redis, memcached..."];
} else if (currentLocalization === 'ua') {
  var sentences = ["Ключові слова: бекенд, php, database, git...", "Ключові слова: mysql, redis, memcached..."];
} else {}
var counter = 0;
function loop() {
